...
public class Fake_transd extends ViewableAtomic
{
    protected Map<String, doubleEnt> arrived, solved;
    protected double clock, total_ta, observation_time;
    public Double count = 0.00;

    public Fake_transd(String name, double Observation_time)
    {
        super(name);
        addInport("in");
        addOutport("out");
        ...
        arrived = new HashMap<String, doubleEnt>();
        solved = new HashMap<String, doubleEnt>();
